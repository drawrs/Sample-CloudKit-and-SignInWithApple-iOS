...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "khilmand.Sample-CloudKit-and-SignInWithApple-iOS", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "khilmand.Sample-CloudKit-and-SignInWithApple-iOS", account: "userIdentifier").deleteItem()
        } catch {
